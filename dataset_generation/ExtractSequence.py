...
PATH_DIR = os.path.join(args.path2ds, 'Sequence', 'S_small')
...
for dirCond in listDir:
    ds_name = 'Sequence_{}_{}'.format(dirCond, ds_num)
    ...
    Data, keydict = generateEmptyStorage(name='Sequence', subset=dirCond)
